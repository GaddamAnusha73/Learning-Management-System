    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text text-sm text-white/80'>Lorem Ipsum id simply dummy text of the printing and 
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <p className='text-sm text-white/80'>The latest news, articles, and resources, sent to your inbox
          weekly.</p>
          <div className='flex items-center gap-2 pt-4'>
            <input type="email" placeholder='Enter your email'
            className='border border-gray-500/30 bg-gray-800 text-gray-500
            placeholder-gray-500 outlinr-none w-64 h-9 rounded px-2 text-sm'/>
