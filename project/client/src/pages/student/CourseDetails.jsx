    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
     ...
     <div className='max-w-xl z-10 text-gray-500'>
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <p className='text-sm'> Course by <span className='text-blue-600 underline'>Education media</span></p>
     ...
     md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
      ...
      <div className='p-5'>
        ...
        text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled':'Enrolled Now'}</button>
        <div className='pt-6'>
